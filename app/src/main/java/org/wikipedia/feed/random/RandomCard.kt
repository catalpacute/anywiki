...
class RandomCard(page: PageSummary, age: Int, wiki: WikiSite) : FeaturedArticleCard(page, age, wiki) {
    ...
    override fun title(): String {
        return L10nUtil.getString(wikiSite().languageCode, R.string.view_random_article_card_title)
    }

    override fun footerActionText(): String {
        return L10nUtil.getString(wikiSite().languageCode, R.string.view_random_article_card_action)
    }
